    ...
    <div class="flex ">
        ...
        <div class="flex-1 p-6 relative left-[100px] w-[1000px]">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold">Thùng rác Danh mục sản phẩm</h1>
                <a href="{{ route('category.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
                    Quay lại
                </a>
            </div>
