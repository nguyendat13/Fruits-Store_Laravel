    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 relative left-[100px] w-[1000px]">
            ...
            <div class="mb-6">
                ...
                <a href="{{ route('category.index') }}" class="text-blue-500 hover:underline">
                    ← Quay lại danh sách
                </a>
            </div>
            ...
            <div class="bg-white shadow-md rounded-md p-6">
                <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Submit -->
                    <div class="mt-6">
                        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Thêm danh mục</button>
                        <a href="{{ route('category.index') }}" class="ml-4 bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
