    ...
    <div>
        <div class="py-10">
            ...
            <div class="container mx-auto">
                <h1 class="text-center text-white text-4xl font-bold relative" style="bottom:150px;">Thương hiệu</h1>
            </div>
        </div>
        ...
        <div class="container mx-auto my-6 px-4">
            <div class="flex space-x-6">
                ...
                <aside class="w-1/4 bg-gray-100 p-4 rounded-lg shadow-md">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('site.product-brand', ['brand_id' => 'all']) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded {{ request('brand_id') == 'all' ? 'bg-gray-300 font-bold' : '' }}">
                                Tất cả
                            </a>
                        </li>
                        @foreach ($brands as $brand)
                            <li>
                                <a href="{{ route('site.product-brand', ['brand_id' => $brand->id]) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded {{ request('brand_id') == $brand->id ? 'bg-gray-300 font-bold' : '' }}">
                                    {{ $brand->name }}
                                </a>
                            </li>
                        @endforeach
                ...
                <div class="w-3/4">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <form method="GET" action="{{ route('site.product-brand') }}" class="flex space-x-4">
                            <!-- Sắp xếp -->
